      ...
      <div className="max-w-3xl flex flex-col gap-8">
        <div className="card-glass p-8 border-t-4 border-t-emerald-500 relative overflow-hidden">
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              ...
              <p className="text-emerald-400 font-medium">Manajemen Kebun Pintar (Versi 1.0.2-beta)</p>
            </div>
          </div>

          <div className="prose prose-invert max-w-none text-gray-300">
            <p className="mb-4 leading-relaxed">
              <strong>FloraSync</strong> adalah web manajemen pertanian pintar dan modern yang didesain secara khusus untuk memenuhi kebutuhan pengelola kebun, <em>greenhouse</em>, maupun petani rumahan. Dibangun dengan konsep <em>Offline-First</em>, FloraSync dapat beroperasi dengan sangat cepat di komputer Anda meskipun tanpa koneksi internet sama sekali, dengan menyimpan data secara aman di dalam sistem penyimpanan lokal <em>browser</em> Anda.
            </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="card-glass p-6 text-center flex flex-col items-center">
            ...
            <h3 className="text-white font-semibold mb-2">Sepenuhnya Lokal</h3>
            <p className="text-sm text-gray-400">Semua data Anda 100% tersimpan di perangkat lokal Anda. Tidak ada data yang dikirim ke server asing.</p>
          </div>
        </div>
      </div>
    </div>
