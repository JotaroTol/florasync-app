        ...
        <div className="card-glass p-8 border-t-4 border-t-emerald-500 relative overflow-hidden">
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              ...
              <p className="text-emerald-400 font-medium">Manajemen Kebun Pintar (Versi 1.1.19) • By JotaroTol</p>
            </div>
          </div>
          ...
          <div className="prose prose-invert max-w-none text-gray-300">
            ...
            <div className="space-y-4">
              {/* v1.1.19 - Bright Emerald (Latest) */}
              <div className="border-l-2 border-emerald-500 pl-4 py-1">
                <div className="flex items-center gap-2 mb-1">
                  <span className="font-bold text-emerald-400">v1.1.19 (Penyempurnaan tata letak dan warna antarmuka Kategori)</span>
